(function (global, factory) {
  ...
  $__default["default"].extend(
    $__default["default"].fn.bootstrapTable.defaults,
    {
  ...
  $__default["default"].BootstrapTable = /*#__PURE__*/ (function (
    _$$BootstrapTable
  ) {
        ...
        value: function init() {
          ...
          $__default["default"](window).on(
            ...
            debounce(function () {
              ...
              var $activeElement = $__default["default"](
              ...
              if (
                Math.abs(old.height - height) > _this.options.heightThreshold ||
                old.width !== width
              ) {
            ...
            this.columns.forEach(function (column) {
              if (_this2.options.columnsHidden.includes(column.field)) {
                if (column.visible !== checked) {
                  _this2._toggleColumn(
                    _this2.fieldsColumnsIndex[column.field],
                    checked,
                    true
                  );
                }
